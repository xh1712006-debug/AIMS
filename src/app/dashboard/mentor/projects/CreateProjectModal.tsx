    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#1E293B] rounded-xl shadow-xl w-full max-w-md overflow-hidden relative">
            <div className="p-4 border-b border-gray-100 dark:border-[#334155] flex justify-between items-center bg-gray-50/50 dark:bg-[#0F172A]/50">
              <h3 className="font-bold text-gray-900 dark:text-[#F1F5F9] text-lg">Tạo Dự án Mới</h3>
