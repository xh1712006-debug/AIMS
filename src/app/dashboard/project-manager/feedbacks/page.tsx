      ...
      <div className="bg-white dark:bg-[#171717] rounded-2xl shadow-sm dark:shadow-none border border-gray-200 dark:border-[#383838] overflow-hidden">
        {itemsRequiringFix.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-[#EDEDED]">Không có công việc nào cần khắc phục!</h3>
            <p className="text-gray-500 dark:text-[#737373] mt-1">Mọi thứ đang hoạt động trơn tru.</p>
          </div>
        ) : (
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-xs font-semibold text-gray-500 dark:text-[#737373] bg-gray-100 dark:bg-[#262626] px-2 py-0.5 rounded">
                        {item.type}
                      </span>
                    </div>
                    
                    <h4 className="text-lg font-bold text-gray-900 dark:text-[#EDEDED] mb-1">{item.title}</h4>
                    <p className="text-sm text-gray-500 dark:text-[#737373]">
                      Dự án: <span className="font-semibold text-gray-700 dark:text-[#D4D4D4]">{item.project.title}</span> 
                      &nbsp;&bull;&nbsp; Intern: <span className="font-semibold text-gray-700 dark:text-[#D4D4D4]">{item.project.intern.name}</span>
                    </p>
                  ...
                  {/* Cột thao tác */}
                  <div className="flex flex-col gap-3 justify-center md:items-end md:w-48 border-t md:border-t-0 md:border-l border-gray-100 dark:border-[#262626] pt-4 md:pt-0 md:pl-6">
                    <Link href={`/dashboard/${item.projectId}/work-items`} className="w-full text-center px-4 py-2 bg-white dark:bg-[#171717] border border-gray-200 dark:border-[#383838] text-gray-700 dark:text-[#D4D4D4] text-sm font-bold rounded-lg hover:bg-gray-50 dark:bg-[#0A0A0A] transition-colors shadow-sm dark:shadow-none">
                      Đến Backlog
                    </Link>
                  </div>
                </div>
