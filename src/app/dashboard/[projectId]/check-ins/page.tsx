                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {session.user.role === 'MENTOR' ? (
                        <form action={async (formData) => {
                          ...
                          <label className="block text-xs font-semibold text-gray-700 dark:text-[#D4D4D4] mb-1">Mentor Action (Ghi chú / Hỗ trợ)</label>
                          <textarea name="mentorAction" defaultValue={ci.mentorAction || ''} rows={2} className="w-full rounded-lg border-gray-300 dark:border-[#383838] ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 p-2 text-sm bg-white dark:bg-[#171717]" placeholder="Ghi chú phương án giải quyết blocker..."></textarea>
