        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 dark:bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#171717] rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
            <div className="px-6 py-4 border-b border-gray-100 dark:border-[#262626] flex justify-between items-center bg-gray-50/50 dark:bg-[#0A0A0A]/50">
              <h3 className="text-lg font-bold text-gray-900 dark:text-[#EDEDED]">Chỉnh sửa Sprint</h3>
            ...
            <div className="p-6 overflow-y-auto flex-1 custom-scrollbar text-left font-normal">
              <form action={handleUpdate} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-[#D4D4D4] mb-1">Tên Sprint</label>
                  <input name="name" defaultValue={sprint.name} required type="text" className="w-full rounded-lg border-gray-300 dark:border-[#383838] ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 p-2 text-sm" />
                </div>
                
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-[#D4D4D4] mb-1">Ngày bắt đầu</label>
                  <input name="startDate" defaultValue={formatDateForInput(sprint.startDate)} required type="date" className="w-full rounded-lg border-gray-300 dark:border-[#383838] ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 p-2 text-sm" />
                </div>
                
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-[#D4D4D4] mb-1">Ngày kết thúc</label>
                  <input name="endDate" defaultValue={formatDateForInput(sprint.endDate)} required type="date" className="w-full rounded-lg border-gray-300 dark:border-[#383838] ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 p-2 text-sm" />
                </div>

                <div className="pt-4 border-t border-gray-100 dark:border-[#262626] flex gap-3 justify-end mt-6">
                  <button 
                    type="button" 
