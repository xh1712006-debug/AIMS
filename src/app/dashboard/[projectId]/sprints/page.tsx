    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-[#737373] mt-1">Theo dõi mục tiêu và tiến độ công việc theo từng giai đoạn.</p>
        </div>
      ...
      <div className="space-y-4">
        {sprints.length === 0 ? (
          <div className="bg-white dark:bg-[#171717] p-8 rounded-2xl shadow-sm dark:shadow-none border border-gray-100 dark:border-[#262626] text-center text-gray-500 dark:text-[#737373]">
